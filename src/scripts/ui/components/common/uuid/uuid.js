...
import {
    format as uuidFormat,
    normalize as uuidNormalize
} from '../../../../infrastructure/utils/uuid';
...
const FormsyText = React.createClass({
    ...
    controlledValue(props = this.props) {
        return convertValue(props.value || props.defaultValue);
    },
      ...
      ...rest } = this.props;
        ...
        return (
            <TextField
                ...
                value={uuidFormat(this.state.value)}
